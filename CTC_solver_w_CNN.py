...
class lstm():
    ...
    def get_model(self, lr):
        ...
        GRAPH_PB_PATH = 'CNN/best_cnn.pb'
        with kback.get_session() as sess:
            print("load graph")
            ...
            final_pool = graph.get_tensor_by_name('pool5/7x7_s1:0')
            final_pool = tf.contrib.layers.flatten(loss3_SLclassifier_0)


        in_dense = (Dense(512))

        in_dense_output = in_dense(final_pool)
        ...
        decode_model = Model([X, input_length], output)
