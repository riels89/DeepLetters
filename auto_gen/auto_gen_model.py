...
def KitModel(weight_file = None):
    ...
    data            = tf.placeholder(tf.float32, shape = (None, 227, 227, 3), name = 'data')
    conv1_7x7_s2_pad = tf.pad(data, paddings = [[0L, 0L], [3L, 4L], [3L, 4L], [0L, 0L]])
    ...
    pool1_3x3_s2_pad = tf.pad(conv1_relu_7x7, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    conv2_3x3_pad   = tf.pad(conv2_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    pool2_3x3_s2_pad = tf.pad(conv2_norm2, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    pool2_3x3_s2    = tf.nn.max_pool(pool2_3x3_s2_pad, [1, 3, 3, 1], [1, 2, 2, 1], padding='VALID', name='pool2/3x3_s2')
    inception_3a_pool_pad = tf.pad(pool2_3x3_s2, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_3a_5x5_pad = tf.pad(inception_3a_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    inception_3a_5x5 = convolution(inception_3a_5x5_pad, group=1, strides=[1, 1], padding='VALID', name='inception_3a/5x5')
    inception_3a_3x3_pad = tf.pad(inception_3a_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_3b_pool_pad = tf.pad(inception_3a_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_3b_3x3_pad = tf.pad(inception_3b_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_3b_5x5_pad = tf.pad(inception_3b_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    pool3_3x3_s2_pad = tf.pad(inception_3b_output, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_4a_pool_pad = tf.pad(pool3_3x3_s2, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_4a_3x3_pad = tf.pad(inception_4a_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    inception_4a_3x3 = convolution(inception_4a_3x3_pad, group=1, strides=[1, 1], padding='VALID', name='inception_4a/3x3')
    inception_4a_5x5_pad = tf.pad(inception_4a_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    inception_4b_pool_pad = tf.pad(inception_4a_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    inception_4b_pool = tf.nn.max_pool(inception_4b_pool_pad, [1, 3, 3, 1], [1, 1, 1, 1], padding='VALID', name='inception_4b/pool')
    loss1_ave_pool_pad = tf.pad(inception_4a_output, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]])
    ...
    inception_4b_5x5_pad = tf.pad(inception_4b_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    inception_4b_5x5 = convolution(inception_4b_5x5_pad, group=1, strides=[1, 1], padding='VALID', name='inception_4b/5x5')
    inception_4b_3x3_pad = tf.pad(inception_4b_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_4c_pool_pad = tf.pad(inception_4b_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_4c_5x5_pad = tf.pad(inception_4c_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    inception_4c_3x3_pad = tf.pad(inception_4c_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_4d_pool_pad = tf.pad(inception_4c_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_4d_3x3_pad = tf.pad(inception_4d_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    inception_4d_3x3 = convolution(inception_4d_3x3_pad, group=1, strides=[1, 1], padding='VALID', name='inception_4d/3x3')
    inception_4d_5x5_pad = tf.pad(inception_4d_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    loss2_ave_pool_pad = tf.pad(inception_4d_output, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]])
    ...
    inception_4e_pool_pad = tf.pad(inception_4d_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_4e_5x5_pad = tf.pad(inception_4e_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    inception_4e_3x3_pad = tf.pad(inception_4e_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    pool4_3x3_s2_pad = tf.pad(inception_4e_output, paddings = [[0L, 0L], [0L, 1L], [0L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_5a_pool_pad = tf.pad(pool4_3x3_s2, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_5a_5x5_pad = tf.pad(inception_5a_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    inception_5a_3x3_pad = tf.pad(inception_5a_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_5b_pool_pad = tf.pad(inception_5a_output, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]], constant_values=float('-Inf'))
    ...
    inception_5b_3x3_pad = tf.pad(inception_5b_relu_3x3_reduce, paddings = [[0L, 0L], [1L, 1L], [1L, 1L], [0L, 0L]])
    ...
    inception_5b_5x5_pad = tf.pad(inception_5b_relu_5x5_reduce, paddings = [[0L, 0L], [2L, 2L], [2L, 2L], [0L, 0L]])
    ...
    prob            = tf.nn.softmax(loss3_SLclassifier_1, name = 'prob')
    return data, loss2_SLclassifier_1, prob, loss1_SLclassifier_1
...
data, loss2_SLclassifier_1, prob, loss1_SLclassifier_1 = KitModel(weight_file ='weights.npy')
with tf.Session() as sess:
    image = cv2.imread('testhandimage.jpg')
    image = cv2.resize(image, (227, 227))
    image = image[np.newaxis, :, :, :]
    print(image.shape)
    sess.run(tf.global_variables_initializer())
    print(np.argmax(sess.run([prob], feed_dict={data: image})))